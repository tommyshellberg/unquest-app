  ...
  const handleStartQuest = async () => {
    try {
      ...
      if (firstStoryQuest) {
        ...
        // Add a small delay to let any animations finish
        setTimeout(() => {
          console.log('Navigating to active quest from first quest');
          // Use push instead of replace to prevent view hierarchy issues

...
export const AVAILABLE_QUESTS: (CustomQuestTemplate | StoryQuestTemplate)[] = [
  ...
  },
  {
    ...
    title: 'An Iron Grip',
    recap:
      'Soldiers have discovered our campsite, leaving us cornered. With no better option, I reached for a heavy iron candlestick, bracing for the fight.',
    durationMinutes: questDuration(27),
    reward: { xp: 50 },
    poiSlug: '', // @todo: add slug when map has 10 POIs
  ...
  },
  {
    ...
    recap:
      "The soldiers found us. Cornered and desperate, I grabbed a sturdy wooden table leg, hoping it's enough.",
    durationMinutes: questDuration(27),
    reward: { xp: 50 },
    poiSlug: '', // @todo: add slug when map has 10 POIs
